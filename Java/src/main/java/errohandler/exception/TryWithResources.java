...
public class TryWithResources {
    public void read(String filename) {
        ...
        try (Scanner in = new Scanner(new FileInputStream(filename))) {
            ...
            // 2. 捕获FileNotFoundException异常（只打印栈信息）
            //    如果要抛出异常，原来用的try final话，该异常会被原始close异常覆盖(原始close覆盖之前FileNotFound异常)
            e.printStackTrace();
        }
...
//            in.close();
    ...
    public static void main(String[] args) {
        ...
        tryWithResources.read("fileNotExist.log");
    }
}
