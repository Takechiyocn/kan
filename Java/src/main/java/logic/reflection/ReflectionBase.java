...
public class ReflectionBase {
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Object m = Class.forName("logic.occupation.Employee").newInstance();
        log.info("Name:" + ((Employee) m).getName() + ",id:" + ((Employee) m).getId());

        // 获取Class对象：Constructor类（有参构造器）
        Class<?> cls = Class.forName("logic.occupation.Employee");
        // 获取类某一构造方法
        ...
        Object n = Class.forName("logic.occupation.Employee").getConstructor(new Class[]{String.class, double.class}).newInstance("logic/test", 1000);
    ...
    private static void clazzCompare() throws ClassNotFoundException {
        ...
        Class cl2 = Class.forName("logic.occupation.Employee");
    ...
    private static void getClazz() throws ClassNotFoundException {
        ...
        // 2. clazz = Class.forName("完整类路径")
        //    当类名保存在字符串中且在运行中可变
        String className = "logic.occupation.Manager";
