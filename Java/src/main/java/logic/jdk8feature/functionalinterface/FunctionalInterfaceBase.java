package logic.jdk8feature.functionalinterface;
...
public class FunctionalInterfaceBase {
    ...
    public static void main(String[] args) {
        ...
        // 抽象方法合并 TODO：
        // a(test)::equals
        System.out.println(Predicate.isEqual("logic/test").test("logic/test"));
        // x(test2) -> a.equals(x) || x -> b.equals(x)
        System.out.println(Predicate.isEqual("logic/test").or(Predicate.isEqual("test2")).test("test2"));
        // x(test3) -> a.equals(x) && x -> b.equals(x)
        System.out.println(Predicate.isEqual("logic/test").and(Predicate.isEqual("test2")).test("test3"));
    }
}
