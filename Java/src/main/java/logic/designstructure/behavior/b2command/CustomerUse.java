package logic.designstructure.behavior.b2command;

import logic.designstructure.behavior.b2command.concretecommand.DanceCommand;
import logic.designstructure.behavior.b2command.concretecommand.PlayPianoCommand;
import logic.designstructure.behavior.b2command.concretecommand.SingSongCommand;
